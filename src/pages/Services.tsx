      ...
      <Container>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {services.map((service, idx) => (
            <article
              key={idx}
              className="relative border border-neutral-200 rounded-xl p-8 bg-black/30 hover:border-transparent hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group overflow-hidden"
              style={{
        ...
        <div className="mt-16 bg-black/30 border border-neutral-200 rounded-xl p-6 lg:p-8">
          <h2 className="text-xl md:text-2xl font-bold mb-4 text-center lg:text-left text-neutral-950">Engagement Model</h2>
          <p className="text-sm md:text-base text-neutral-600 mb-6 leading-relaxed text-center lg:text-left">

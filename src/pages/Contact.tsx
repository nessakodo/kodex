            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-black/30 border border-neutral-200 rounded-xl p-6 lg:p-8">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full h-10 px-3 rounded-md border border-neutral-200 bg-black/30 text-neutral-950 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-blue focus-visible:ring-offset-2"
                >

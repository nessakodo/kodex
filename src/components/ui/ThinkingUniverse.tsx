...
export default function ThinkingUniverse() {
  ...
  useEffect(() => {
    ...
    // Create particles with improved distribution and performance optimization
    const particlesGeometry = new THREE.BufferGeometry();
    // Reduce particle count for better performance and CSP compliance
    ...
    const pointLight1 = new THREE.PointLight(0x5eb8ff, 0.3);
